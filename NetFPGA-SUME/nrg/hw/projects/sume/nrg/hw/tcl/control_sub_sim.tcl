...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M08_AXI
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M10_AXI
  ...
  set_property -dict [ list CONFIG.NUM_MI {11} CONFIG.TRANSLATION_MODE {0} ] $axi_interconnect_0
