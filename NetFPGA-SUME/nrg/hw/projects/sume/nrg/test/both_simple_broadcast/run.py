...
for i in range(num_broadcast):
    pkt = make_IP_pkt(src_MAC="aa:bb:cc:dd:ee:ff", dst_MAC=routerMAC[0],
                      ...
                      dst_IP="192.168.1.1", pkt_len=60+i)
...
#    # Expecting the LUT_MISS counter to be incremented by 0x14, 20 packets
    ...
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 61)
    ...
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 64)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x10)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x11)
    nftest_regread_expect(SUME_STATS_0_INDIRECTCOMMAND(), 0x110)
    nftest_regread_expect(SUME_STATS_0_INDIRECTREPLY(), 1)
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 59)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x10)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x11)
    nftest_regread_expect(SUME_STATS_0_INDIRECTCOMMAND(), 0x110)
    nftest_regread_expect(SUME_STATS_0_INDIRECTREPLY(), 0)
 #   nftest_regread_expect(SUME_STATS_0_DEBUG(),0)
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 0x10000004)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x10)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x11)
    nftest_regread_expect(SUME_STATS_0_INDIRECTCOMMAND(), 0x110)
    nftest_regread(SUME_STATS_0_INDIRECTREPLY())
    
    nftest_barrier()

#Test indirect write
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 61)
    nftest_regwrite(SUME_STATS_0_INDIRECTWRDATA(),0)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x0)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x1)
    nftest_regread_expect(SUME_STATS_0_INDIRECTCOMMAND(), 0x100)  
    nftest_regwrite(SUME_STATS_0_INDIRECTADDRESS(), 64)
    nftest_regwrite(SUME_STATS_0_INDIRECTWRDATA(),0)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x0)
    nftest_regwrite(SUME_STATS_0_INDIRECTCOMMAND(), 0x1)
